...
UCLASS()
class SURVIVEIT_API UResourceItem : public UBaseItem
{
	GENERATED_BODY()
...
//	void UpdateWidget();
//
//	void Initialize(EResourceType Type, int32 StartQuantity, int32 NewStackMax, UTexture2D* NewItemIcon, FText NewItemName);
//
//private:
//
